...
public class SemuaProdukAdapter extends RecyclerView.Adapter<SemuaProdukAdapter.SemuaProdukViewHolder>  {
    Context context;
    List<SemuaProduk> semuaProdukList;

    public SemuaProdukAdapter(Context context, List<SemuaProduk> semuaProdukList){
    ...
    @NonNull
    @Override
    public SemuaProdukAdapter.SemuaProdukViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.produkterbaru_row_item, parent, false);
        return new SemuaProdukAdapter.SemuaProdukViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull SemuaProdukAdapter.SemuaProdukViewHolder holder, int position) {
    ...
    public static class SemuaProdukViewHolder extends RecyclerView.ViewHolder{

        TextView namaProduk;
        ImageView gambarProduk;
        ConstraintLayout bg;

        public SemuaProdukViewHolder(@NonNull View itemView) {
            super(itemView);

            namaProduk = itemView.findViewById(R.id.namaProdukTerbaru);
