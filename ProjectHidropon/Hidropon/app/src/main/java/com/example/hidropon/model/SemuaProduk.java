...
public class SemuaProduk {
    private int id_kategori;
    private String id_produk, nama_produk, foto_produk, deskripsi_produk, harga_produk, berat_produk;

    public SemuaProduk(String id_produk, int id_kategori, String nama_produk, String harga_produk, String berat_produk, String foto_produk, String deskripsi_produk) {
